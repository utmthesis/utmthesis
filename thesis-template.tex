...
\author{The Author}  % Write in title case. It will be changed automatically to uppercase where necessary.
...
% 8. Thesis Proposal
\superone{M.Y. Supervisor} % Write in title case. It will be changed automatically to uppercase where necessary.
\supertwo{M.Y. Other Supervisor} % Write in title case. It will be changed automatically to uppercase where necessary.
\superthree{M.Y. Superlong named supervisor} % Write in title case. It will be changed automatically to uppercase where necessary.
% \superfour{Fourth SV}
% \superfive{Fifth SV}
